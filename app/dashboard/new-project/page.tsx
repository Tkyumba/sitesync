        ...
        <div style={{ background: '#1C1F26', border: '1px solid #2D3139', borderRadius: '16px', padding: '28px' }}>
          <form onSubmit={handleSubmit}>
            {[
              ...
              <div key={field.label} style={{ marginBottom: '18px' }}>
                ...
                <input
                  ...
                  style={{ width: '100%', boxSizing: 'border-box' as const, background: '#0F1117', border: '1px solid #2D3139', borderRadius: '10px', padding: '12px 14px', color: '#FFFFFF', fontSize: '14px', outline: 'none' }}
            ...
            <button type="submit" disabled={loading}
              style={{ width: '100%', marginTop: '8px', background: loading ? '#7C3A1A' : 'linear-gradient(135deg, #F97316, #EA580C)', border: 'none', borderRadius: '10px', padding: '13px', color: '#FFFFFF', fontSize: '15px', fontWeight: '600', cursor: loading ? 'not-allowed' : 'pointer', boxShadow: '0 4px 15px rgba(249, 115, 22, 0.3)' }}>
